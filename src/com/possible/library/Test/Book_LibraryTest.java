...
public class Book_LibraryTest {
   ...
   private LibraryUser user1 = new Teacher();
    ...
    private CustomHashMap<String, Book> libraryBooks = new CustomHashMap();
    ...
    @Test
    public void shouldReturnLibraryNotNull() {
        Assert.assertNotNull(library1);
    }

    @Test
    public void shouldReturnUserNotNull(){
        Assert.assertNotNull(user1);
    }

    @Test
    public void shouldReturnBookNotNull(){
...
//    }
    ...
    public void shouldReturnNoNumberOfCopies(){
        Assert.assertEquals(3, book1.getnoOfCopies());
    }
